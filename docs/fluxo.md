# Fluxo de Trabalho — Fábrica GilCFP
...
5. Envia o vídeo pra aba "Editor"
...
```
1. Gilberto abre aba "Inteligência"
2. Clica "Atualizar Tendências"
3. Sistema raspa fontes dos EUA (Apify)
4. Mostra temas em alta com sugestão de adaptação pro BR
...
```
[Reel publicado] → [Usuário comenta "N8N"] → [ManyChat captura]
                                        ↓
